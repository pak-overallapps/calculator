...
class CalculatorTestsSubtraction: XCTestCase {
    ...
    func testSubtractionPP() {
        ...
        XCTAssertEqual(self.operation4, "7")
    }
    
    func testSubtractionPN() {
        // Positive + negative
        self.operation0 = Calculator.shared.didTapClear()
        ...
        XCTAssertEqual(self.operation5, "4")
    }
    
    func testSubtractionNN() {
        // Negative + negative
        self.operation0 = Calculator.shared.didTapClear()
        
        self.operation1 = Calculator.shared.didTap(number: 8)
        self.operation2 = Calculator.shared.didTapPlusMinus()
        self.operation3 = Calculator.shared.didTapSubtraction()
        ...
        XCTAssertEqual(self.operation6, "-6")
    }
}
